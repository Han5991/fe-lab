...
import { defineContent } from '../shared/contentConfig.ts';
...
export const testContent: ContentApi = createContent(
  defineContent({ root: resolve(WORKSPACE_ROOT, 'apps', 'blog', 'web') }),
);
