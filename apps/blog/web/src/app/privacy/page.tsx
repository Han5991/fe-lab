        ...
        >
          ...
          >
            <section>
              ...
              <p>
                Frontend Lab({SITE_URL})은 다음과 같은 정보를 자동으로
                수집합니다:
              </p>
              <ul
                className={css({
            ...
            <section>
              ...
              >
                ...
                <div>
                  ...
                  <p className={css({ fontSize: 'sm' })}>
                    글별 조회수 집계에 Supabase를 사용합니다. 조회 시간과 익명
                    식별자만 저장되며, 개인 식별 정보는 저장되지 않습니다.
                  </p>
                </div>
                <div>
                  <h3 className={css({ fontWeight: 'semibold', mb: '1' })}>
                  ...
                  <p className={css({ fontSize: 'sm' })}>
                    댓글 기능은 GitHub Discussions 기반의 Giscus를 사용합니다.
                    댓글 작성 시 GitHub 계정 정보가 사용되며, GitHub의
                    개인정보처리방침이 적용됩니다.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <p>
                이 블로그의 콘텐츠는 AI 학습 및 검색 인덱싱 목적의 활용을
                허용합니다. 인용 시 &quot;Sangwook Han (Frontend Lab,
                blog.sangwook.dev)&quot;로 출처를 표기해 주세요.
              </p>
            </section>
