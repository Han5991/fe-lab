...
export const PostNavigation = ({ prev, next, seriesNav }: PostNavigationProps) => {
    return (
        <div className={css({ mt: '12', mb: '8' })}>
                ...
                >
                    ...
                    >
                        {seriesNav.prev ? (
                            ...
                            >
                                <span className={css({ fontSize: 'xs', color: 'gray.500' })}>← 이전</span>
                                <span
                                    className={css({
                                        fontSize: 'sm',
                                        fontWeight: 'medium',
                        ...
                        {seriesNav.next ? (
                            ...
                            >
                                <span className={css({ fontSize: 'xs', color: 'gray.500' })}>다음 →</span>
                                <span
                                    className={css({
                                        fontSize: 'sm',
                                        fontWeight: 'medium',
            ...
            >
                {prev ? (
                    ...
                    >
                        <span className={css({ fontSize: 'xs', color: 'gray.500' })}>← 이전 글</span>
                        <span
                            className={css({
                                fontSize: 'sm',
                                fontWeight: 'medium',
                ...
                {next ? (
                    ...
                    >
                        <span className={css({ fontSize: 'xs', color: 'gray.500' })}>다음 글 →</span>
                        <span
                            className={css({
                                fontSize: 'sm',
                                fontWeight: 'medium',
