...
> 그중에 제가 gemini-cli에 관심을 가지게된 이유는 javascript로 되어 있기 떄문이았습니다.  
...
이번 작업은 정말 내가 ai와 함께 코드베이스를 학습하고 기여할 부분을 찾았으며 구글의 프로젝트에 내가 성능개선을 위한 코드를 넣었다는 것에 매우 기쁜 작업으로 기억이 된다.
