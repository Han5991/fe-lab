...
excerpt: '디자이너가 제각각이던 다섯 개 서비스의 디자인을 한 벌로 모았습니다. Turborepo·Mantine·Panda CSS로 시스템을 세우고 디자인 토큰부터 컴포넌트 제작, 문서화와 협업 프로세스 확립까지 하나씩 만들어간 기록입니다.'
thumbnail: '/og/design-system-start.png'
---
...
![디자인 토큰의 계층 구조를 나타낸 다이어그램](https://velog.velcdn.com/images/rewq5991/post/69b51bf0-94c8-47fd-bcbf-859ff8346f34/image.png)
