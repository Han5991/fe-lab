---
title: '컴포넌트에 인터렉션 레이어 이쁘게 씌우기'
date: '2025-02-10'
status: published
slug: 'adding-interaction-layers-to-components'
excerpt: 'hover·focus·press마다 색이 정확히 달라져야 하는데 opacity로는 의도한 색이 안 나오고, div를 덮으면 클릭 이벤트가 죽습니다. 가상 요소 ::after로 두 문제를 한 번에 푼 방법을 정리했습니다.'
thumbnail: '/og/adding-interaction-layers-to-components.png'
---
